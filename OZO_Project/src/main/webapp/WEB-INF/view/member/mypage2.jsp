                  						...
                  						<li> 
											...
											<c:choose>
												<c:when test="${reserve.state eq 0}">
													<span class="btn btn-warning btn-mini btn-rounded">대기</span>
												</c:when>
												<c:when test="${reserve.state eq 1}"> 
													<span class="btn btn-blue btn-mini btn-rounded" style="border-radius: 12px;">승인</span>
												</c:when>
												<c:when test="${reserve.state eq 2}"> 
													<span class="btn btn-inverse btn-mini btn-rounded">후기 작성 완료</span>
												</c:when>
												<c:when test="${reserve.state eq -1}"> 
													<span class="btn btn-mini btn-rounded">취소 완료</span>
												</c:when>
												<c:otherwise>
													<span class="btn btn-danger btn-mini btn-rounded">거부</span>
												</c:otherwise>
											</c:choose>
											<br>
